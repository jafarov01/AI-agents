...
`;
  ...
  try {
    ...
    console.error("Failed to parse architecture response from Gemini:", rawResponse?.substring(0, 200) || 'No response');
    throw new Error("Could not generate architecture plan.");
  }
}